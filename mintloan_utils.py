...
class utils(object):
    ...
    def update_basic_profile(self, loginId=None, authToken=None, companyName=None, companyID=None, division=None, subDevision=None, age=None, currentCity=None, address=None, companyNo=None, dob=None, experience=None, gender=None, monthlyIncome=None, education=None, lifeStage=None, name=None, email=None, placeOfBirth=None, userCategory=None, alternateMobNo=None):
        ...
        if name and companyName and loginId:
...
class DB(object):
    ...
    def __init__(self, id='', cursor=None, mydb='', dictcursor=None, CommitRequired=False, path=".", filename="mysql-dev.config", raiseError=True, debug=False):
    ...
    def Request(self,**indict):
        ...
        assert_dict = {'fetchOnCustomerID':['customerID'], 'login': ['password', 'loginID'], 'logout': ['loginID'], 'viewUser': ['loginID'],  'resetPassword': ['loginID'],
		       ...
		       'aadharFill': ['customerID', 'aadharNo', 'name', 'dob', 'gender', 'house', 'street', 'careOf', 'landMark',
                                      'locality', 'villageTownCity', 'district', 'subDistrict', 'pinCode', 'postOffice', 'state', 'country'], 'dashboard_verification':['company_name'],
                        'lead_creation':['primary_phone_number'],'disbursementFile':['customerID'],
			...
			'customerID'],'whatsTemplateUpload':['docType'],'disbursalDataUpload':['docType'],'getLoanLimit':['mobileNumber'],'companyGroup':['groupName'],'grantDashboard':['division','subDivision'],'grantUpload':['docType'],'update_lead' : ['lead_id'],'paymentDisbursalReport': ['loanRefIDs'],'docList':['docType','days'],'bulkLeadUpload':['docType'], 'showSmsExtract':[{'page':['startIndex','size']}, 'customerID'], 
