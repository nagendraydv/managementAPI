...
class SwiggyRelianceTransactionFeedUploadResource:
        ...
        if ((not validate.Request(api='incomeDataUpload', request={"msgHeader": msgHeader, "data": data})) or
            ...
            try:
                ...
                if val_error:
                    ...
                    mapping = {"company code": "COMPANY_CODE", "sch+pla": "SCHEME_PLAN", "option": "SCHEME_OPTION", "employee no": "EMPLOYEE_NO",
                               "acno / folio no.": "FOLIO", "investor name": "INVESTOR_NAME", "pan / pekrn no.": "PAN",
                               "distributor code": "DISTRIBUTOR_CODE", "euin code": "EUIN", "amount": "AMOUNT", "remarks (mandetory)": "REMARKS",
                    ...
                    for i in range(1, len(d)):
                        ...
                        inserted = db.Insert(
                            db="gc_reliance", table="mw_swiggy_reliance_transaction_feed", compulsory=False, date=False, CREATED_DATE=cdate, **r)
                    if inserted:
